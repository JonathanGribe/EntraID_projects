...
## Stage 2 - Created our first Conditional Access policy ([based on CA001](https://github.com/JonathanGribe/EntraID_projects/blob/main/entra_project_2_Authentication/02_entra_project_2_Baseline.md## Conditional Access Policies))
